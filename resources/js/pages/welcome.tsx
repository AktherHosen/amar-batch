    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-white dark:bg-[#0a0a0a]">
                ...
                <header className="fixed top-0 left-0 right-0 z-50 border-b border-gray-100 bg-white/80 backdrop-blur-md dark:border-gray-800 dark:bg-[#0a0a0a]/80">
                    <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="hidden whitespace-nowrap text-xl font-bold text-gray-900 sm:inline dark:text-white">
                                Karnaphuli Alpha Academy
                            </span>
                            <span className="whitespace-nowrap text-xl font-bold text-gray-900 sm:hidden dark:text-white">
                                KAA
                            </span>
                        </div>
                ...
                {/* Stats Section */}
                <section className="py-10 border-y border-gray-100 sm:py-16 dark:border-gray-800">
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="grid grid-cols-2 gap-4 sm:gap-8 md:grid-cols-4">
                            {displayStats.map((stat) => (
                                <div key={stat.label} className="text-center">
                                    <div className="text-2xl font-bold text-gray-900 sm:text-4xl dark:text-white">{stat.number}</div>
                    ...
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid gap-4 sm:gap-8 md:grid-cols-2 lg:grid-cols-3">
                            {features.map((feature) => (
                                <div
                                    key={feature.title}
                                    className="group rounded-2xl border border-gray-100 bg-white p-5 shadow-sm transition-all hover:shadow-lg hover:border-blue-200 sm:p-8 dark:border-gray-800 dark:bg-gray-900 dark:hover:border-blue-800"
                                >
                ...
                <section className="py-16 bg-gray-50 sm:py-24 dark:bg-gray-900">
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="mb-10 text-center sm:mb-16">
                            <h2 className="mb-4 text-2xl font-bold text-gray-900 sm:text-3xl lg:text-4xl dark:text-white">
                        ...
                        <div className="grid gap-8 sm:gap-8 md:grid-cols-3">
                            <div className="text-center">
                                ...
                                <h3 className="mb-2 text-base font-semibold text-gray-900 sm:text-lg dark:text-white">Create Account</h3>
                                <p className="text-sm text-gray-600 sm:text-base dark:text-gray-400">Sign up and set up your coaching center profile in seconds.</p>
                            </div>
                            <div className="text-center">
                                <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-blue-600 text-xl font-bold text-white sm:h-16 sm:w-16 sm:text-2xl">
                                    2
                                </div>
                                <h3 className="mb-2 text-base font-semibold text-gray-900 sm:text-lg dark:text-white">Add Students</h3>
                                <p className="text-sm text-gray-600 sm:text-base dark:text-gray-400">Import or add your students and organize them into batches.</p>
                            </div>
                            <div className="text-center">
                                <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-blue-600 text-xl font-bold text-white sm:h-16 sm:w-16 sm:text-2xl">
                                    3
                                </div>
                                <h3 className="mb-2 text-base font-semibold text-gray-900 sm:text-lg dark:text-white">Start Managing</h3>
                                <p className="text-sm text-gray-600 sm:text-base dark:text-gray-400">Track attendance, collect fees, and generate reports daily.</p>
                            </div>
                        </div>
                    </div>
                </section>
