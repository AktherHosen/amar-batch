...
export const translations: Record<Locale, Record<string, string>> = {
    bn: {
        ...
        'settings.theme_mode_desc': 'আপনার ডিভাইসে অ্যাপ কেমন দেখাতে চান তা বেছে নিন।',
        'settings.light': 'লাইট',
        ...
        'settings.accent_color_desc': 'বাটন, লিঙ্ক, সক্রিয় অবস্থা এবং ফোকাস রিংয়ে প্রয়োগ হয়।',
        'settings.corner_radius': 'কোনার রেডিয়াস',
        'settings.corner_radius_desc': 'বাটন, ইনপুট, কার্ড এবং ডায়ালগের গোলাকারতা।',
        'settings.custom_size': 'কাস্টম সাইজ',
        'settings.sharp': 'সূক্ষ্ম',
        'settings.rounded': 'গোলাকার',
        'settings.date_time': 'তারিখ ও সময়',
        'settings.date_time_desc': 'তারিখ এবং সময় কেমন দেখাতে হয় তা বেছে নিন।',
