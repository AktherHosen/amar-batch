...
export const translations: Record<Locale, Record<string, string>> = {
    bn: {
        ...
        'dashboard.review': 'পর্যালোচনা করুন',
        'dashboard.low_capacity': 'ব্যাচ প্রায় পূর্ণ হয়ে এসেছে',
        'dashboard.no_attendance_today': 'আজ কোনো উপস্থিতি রেকর্ড হয়নি',
        'dashboard.mark_attendance_desc': 'উপস্থিতি নিন এবং পরিসংখ্যান দেখুন',
        'dashboard.no_enrollments': 'কোনো ভর্তি তথ্য নেই',
        'dashboard.no_enrollments_desc': 'ভর্তির প্রবণতা এখানে দেখা যাবে',
        'dashboard.no_fees': 'কোনো বেতন তথ্য নেই',
        'dashboard.no_fees_desc': 'বেতন সংগ্রহের প্রবণতা এখানে দেখা যাবে',
        'dashboard.view_plans': 'প্ল্যান দেখুন',
        ...
        'batches.manage': 'ব্যাচ পরিচালনা',
        'batches.assigned_teachers': 'নিযুক্ত শিক্ষক',
        ...
        // Roles
        'roles.index': 'রোল ও অনুমতি',
        'roles.create': 'নতুন রোল',
        'roles.edit': 'রোল সম্পাদনা',
        'roles.update': 'রোল আপডেট',
        ...
        'roles.slug': 'স্লাগ *',
        'roles.slug_placeholder': 'যেমন teacher',
        ...
        'roles.col_users': 'ব্যবহারকারী',
        'roles.col_permissions': 'অনুমতি',
        ...
        'users.role': 'রোল',
        'users.select_role': 'রোল নির্বাচন করুন',
        ...
        'users.filter_by_role': 'রোল দিয়ে ফিল্টার',
        'users.all_roles': 'সকল রোল',
        ...
        'reports.unpaid_title': 'বকেয়া স্টুডেন্ট',
        'reports.unpaid_desc': 'বকেয়া বেতনের সাথে স্টুডেন্টদের দেখুন',
        'reports.unpaid_students_count': 'বকেয়া স্টুডেন্ট',
        ...
        'fees.generate_receipt': 'রসিদ তৈরি করুন',
        'fees.receipt_desc': 'রসিদ তৈরি করতে মাস নির্বাচন করুন',
        'fees.unpaid_filter': 'বকেয়া মাস',

        // Receipts
        'receipts.title': 'বেতনরসিদ',
        'receipts.desc': 'বেতন রসিদ পরিচালনা ও তৈরি করুন',
        'receipts.new': 'নতুন রসিদ',
        'receipts.search_placeholder': 'রসিদ খুঁজুন...',
        ...
        'receipts.column_student': 'শিক্ষার্থী',
        'receipts.column_batch': 'ব্যাচ',
        'receipts.column_period': 'সময়কাল',
        'receipts.column_amount_paid': 'পরিশোধিত পরিমাণ',
        'receipts.column_amount_due': 'বকেয়া পরিমাণ',
        'receipts.column_date': 'তারিখ',
        'receipts.label_student': 'শিক্ষার্থী',
        'receipts.label_batch': 'ব্যাচ',
        'receipts.label_month': 'মাস',
        'receipts.label_year': 'বছর',
        'receipts.label_amount_paid': 'পরিশোধিত পরিমাণ',
        'receipts.label_amount_due': 'বকেয়া পরিমাণ',
        'receipts.label_notes': 'নোট',
        'receipts.notes_placeholder': 'ঐচ্ছিক নোট',
        'receipts.select_student': 'শিক্ষার্থী নির্বাচন করুন',
        'receipts.select_student_first': 'প্রথমে শিক্ষার্থী নির্বাচন করুন',
        'receipts.select_batch': 'ব্যাচ নির্বাচন করুন',
        'receipts.creating': 'তৈরি হচ্ছে...',
        'receipts.show_title': 'রসিদ',
        'receipts.show_generated': 'তৈরি হয়েছে',
        'receipts.fee_receipt': 'বেতনরসিদ',
        'receipts.receipt_number': 'রসিদ নম্বর',
        'receipts.date': 'তারিখ',
        'receipts.student_name': 'শিক্ষার্থীর নাম',
        'receipts.phone': 'ফোন',
        'receipts.guardian_name': 'অভিভাবকের নাম',
        'receipts.guardian_phone': 'অভিভাবকের ফোন',
        'receipts.subject': 'বিষয়',
        'receipts.period': 'সময়কাল',
        'receipts.amount_due': 'বকেয়া পরিমাণ',
        'receipts.amount_paid': 'পরিশোধিত পরিমাণ',
        'receipts.notes': 'নোট',
        'receipts.received_by': 'গ্রহণকারী',
        ...
        'subscription.manual_payment_desc': 'নিচের তথ্যগুলো পূরণ করুন। আমাদের টিম যাচাই করার পর আপনার সাবস্ক্রিপশন সক্রিয় হবে।',
        ...
        'settings.appearance': 'থিম সেটিংস',
        'settings.appearance_desc':
            'আপনার অ্যাকাউন্টের চেহারা সেটিংস আপডেট করুন',
        'settings.coaching_center': 'কোচিং সেন্টার',
        'settings.coaching_center_desc':
            'আপনার কোচিং সেন্টারের তথ্য, ব্র্যান্ডিং এবং পছন্দসমূহ পরিচালনা করুন।',
        'settings.center_name': 'কোচিং সেন্টারের নাম *',
        'settings.phone': 'ফোন',
        'settings.timezone': 'টাইমজোন',
        'settings.currency': 'মুদ্রা',
        'settings.currency_symbol': 'মুদ্রা প্রতীক',
        'settings.academic_year': 'একাডেমিক বছর',
        'settings.receipt_prefix': 'রসিদ উপসর্গ',
        'settings.student_id_prefix': 'স্টুডেন্ট আইডি উপসর্গ',
        'settings.default_attendance': 'ডিফল্ট উপস্থিতি',
        'settings.manual': 'ম্যানুয়াল',
        'settings.auto_absent': 'অটো অনুপস্থিত (সময় পর)',
        'settings.invoice_footer': 'ইনভয়েস ফুটার টেক্সট',
        'settings.primary_color': 'প্রাথমিক রং (পিডিএফের জন্য)',
        'settings.logo': 'লোগো',
        'settings.save_changes': 'পরিবর্তন সংরক্ষণ করুন',
        'settings.theme_mode': 'থিম মোড',
        'settings.theme_mode_desc':
            'আপনার ডিভাইসে অ্যাপ কেমন দেখাতে চান তা বেছে নিন।',
        'settings.light': 'লাইট',
        'settings.light_desc': 'উজ্জ্বল ও পরিষ্কার',
        'settings.dark': 'ডার্ক',
        'settings.dark_desc': 'চোখে সহজ',
        'settings.system': 'সিস্টেম',
        'settings.system_desc': 'ডিভাইসের সেটিংস অনুসরণ করুন',
        'settings.accent_color': 'অ্যাকসেন্ট রং',
        'settings.accent_color_desc':
            'বাটন, লিঙ্ক, সক্রিয় অবস্থা এবং ফোকাস রিংয়ে প্রয়োগ হয়।',
        'settings.corner_radius': 'কোনার রেডিয়াস',
        'settings.corner_radius_desc':
            'বাটন, ইনপুট, কার্ড এবং ডায়ালগের গোলাকারতা।',
        'settings.custom_size': 'কাস্টম সাইজ',
        'settings.sharp': 'সূক্ষ্ম',
        'settings.rounded': 'গোলাকার',
        'settings.date_time': 'তারিখ ও সময়',
        'settings.date_time_desc':
            'তারিখ এবং সময় কেমন দেখাতে হয় তা বেছে নিন।',
        'settings.date_format': 'তারিখ ফরম্যাট',
        'settings.time_format': 'সময় ফরম্যাট',
        'settings.hour_12': '১২ ঘণ্টা (AM/PM)',
        'settings.hour_24': '২৪ ঘণ্টা',
        'settings.layout': 'লেআউট',
        'settings.layout_desc': 'সাইডবার এবং নেভিগেশন আচরণ কাস্টমাইজ করুন।',
        'settings.sidebar_style': 'সাইডবার স্টাইল',
        'settings.sidebar_full': 'ফুল (লেবেল দৃশ্যমান)',
        'settings.sidebar_compact': 'কমপ্যাক্ট (শুধু আইকন)',
        'settings.default_page': 'ডিফল্ট ল্যান্ডিং পেজ',
        'settings.preview': 'প্রিভিউ',
        'settings.preview_desc': 'আপনার কাস্টমাইজেশনের একটি লাইভ নমুনা।',
        ...
        'super_admin.subscriptions': 'সাবস্ক্রিপশন',
        'super_admin.on_trial': 'ট্রায়ালে',
        'super_admin.view_all': 'সব দেখুন',
        'super_admin.recent_payments': 'সাম্প্রতিক পেমেন্ট',
        'super_admin.no_coaching_centers': 'এখনো কোনো কোচিং সেন্টার নেই।',
        'super_admin.no_payments': 'এখনো কোনো পেমেন্ট নেই।',
        ...
        'super_admin.edit_plan': 'প্ল্যান আপডেট',
        'super_admin.plan_name': 'প্ল্যানের নাম',
        'super_admin.slug': 'স্লাগ',
        'super_admin.description': 'বিবরণ',
        'super_admin.monthly_price': 'মাসিক মূল্য (৳)',
        'super_admin.yearly_price': 'বার্ষিক মূল্য (৳)',
        'super_admin.max_students': 'সর্বোচ্চ ছাত্র (-1 = অসীমিত)',
        'super_admin.max_staff': 'সর্বোচ্চ স্টাফ (-1 = অসীমিত)',
        'super_admin.max_batches': 'সর্বোচ্চ ব্যাচ (-1 = অসীমিত)',
        ...
        'super_admin.payments': 'পেমেন্ট',
        'super_admin.payment_history': 'পেমেন্ট ইতিহাস',
        'super_admin.all_transactions': 'সমস্ত কোচিং সেন্টারের লেনদেন',
        'super_admin.total': 'মোট',
        'super_admin.successful': 'সফল',
        'super_admin.pending': 'মুলতুবি',
        'super_admin.failed': 'ব্যর্থ',
        'super_admin.revenue': 'আয়',
        'super_admin.search_tenant_or_tx': 'টেন্যান্ট বা TX ID খুঁজুন...',
        'super_admin.contacts': 'যোগাযোগ',
        'super_admin.contact_messages': 'যোগাযোগ বার্তা',
        'super_admin.manage_messages': 'যোগাযোগ ফর্মের বার্তা পরিচালনা করুন',
        'super_admin.unread': 'অপঠিত',
        'super_admin.replied': 'উত্তর দেওয়া হয়েছে',
        'super_admin.inbox': 'ইনবক্স',
        'super_admin.no_messages': 'এখনো কোনো যোগাযোগ বার্তা নেই।',
        'super_admin.reply_to': 'উত্তর দিন',
        'super_admin.type_reply': 'আপনার উত্তর লিখুন...',
        'super_admin.send_reply': 'উত্তর পাঠান',
        'super_admin.sending': 'পাঠাচ্ছে...',
        'super_admin.previous_reply': 'পূর্ববর্তী উত্তর',
        'super_admin.search_name_email': 'নাম, ইমেইল, বিষয় খুঁজুন...',
        'super_admin.unread_filter': 'অপঠিত',
        'super_admin.all': 'সব',
        'super_admin.students': 'ছাত্র',
        'super_admin.batches': 'ব্যাচ',
        'super_admin.users': 'ব্যবহারকারী',
        'super_admin.revenue_label': 'আয়',
        'super_admin.paid': 'পরিশোধিত',
        'super_admin.recent_payments_short': 'সাম্প্রতিক পেমেন্ট',
        'super_admin.subscription': 'সাবস্ক্রিপশন',
        'super_admin.no_plan': 'কোনো প্ল্যান নেই',
        'super_admin.until': 'পর্যন্ত',
        'super_admin.plan_details': 'প্ল্যানের বিবরণ',
        'super_admin.change_plan': 'প্ল্যান পরিবর্তন করুন',
        'super_admin.no_plan_assigned': 'কোনো প্ল্যান নির্ধারিত নেই।',
        'super_admin.select_plan': 'একটি প্ল্যান নির্বাচন করুন',
        'super_admin.assign_plan': 'প্ল্যান নির্ধারণ করুন',
        'super_admin.price': 'মূল্য',
        'super_admin.deactivate': 'নিষ্ক্রিয় করুন',
        ...
        'super_admin.create_feature_desc': 'একটি নতুন বৈশিষ্ট্য যোগ করুন যা প্ল্যানে নির্বাচন করা যাবে।',
        ...
        'super_admin.delete_feature_confirm': 'আপনি কি নিশ্চিত "{name}" বৈশিষ্ট্যটি মুছে ফেলতে চান?',
        ...
        'super_admin.subject': 'বিষয়',
        'super_admin.no_contacts': 'এখনো কোনো যোগাযোগ বার্তা নেই।',
        'super_admin.amount': 'পরিমাণ',
        'super_admin.billing': 'বিলিং',
        ...
        'super_admin.payment_settings_desc': 'পেমেন্ট গেটওয়ে এবং ম্যানুয়াল পেমেন্ট কনফিগার করুন',
        ...
        'super_admin.manual_payment_instructions': 'ম্যানুয়াল পেমেন্ট নির্দেশনা',
        'super_admin.manual_payment_instructions_placeholder': 'গ্রাহকদের জন্য পেমেন্ট নির্দেশনা লিখুন...',
        'super_admin.manual_payment_instructions_help': 'এই নির্দেশনা গ্রাহকদের সাবস্ক্রিপশন পেজে দেখানো হবে।',
        'super_admin.manual_payments_desc': 'ম্যানুয়াল পেমেন্ট পর্যালোচনা এবং অনুমোদন করুন',
        ...
        'super_admin.approve_payment_confirm': 'আপনি কি নিশ্চিত এই পেমেন্টটি অনুমোদন করতে চান? এটি গ্রাহকের সাবস্ক্রিপশন সক্রিয় করবে।',
        'super_admin.reject_payment': 'পেমেন্ট প্রত্যাখ্যান করুন',
        'super_admin.reject_payment_confirm': 'আপনি কি নিশ্চিত এই পেমেন্টটি প্রত্যাখ্যান করতে চান?',
        ...
        'super_admin.email': 'ইমেইল',
        'super_admin.inactive': 'নিষ্ক্রিয়',
        'super_admin.status': 'স্ট্যাটাস',
        ...
        // Welcome / SEO
        'welcome.hero_title': 'আমার ব্যাচ',
        'welcome.hero_subtitle':
            'আপনার কোচিং সেন্টারের সম্পূর্ণ ব্যবস্থাপনা সমাধান',
        'welcome.hero_description':
            'স্টুডেন্টদের ট্র্যাক করুন, ব্যাচ পরিচালনা করুন, উপস্থিতি নির্ধারণ করুন, বেতন সংগ্রহ করুন এবং রিপোর্ট তৈরি করুন — সবকিছু একটি ড্যাশবোর্ড থেকে। বাংলাদেশের কোচিং সেন্টারগুলোর জন্য মাল্টি-টেন্যান্ট সাপোর্ট, রোল-ভিত্তিক প্রবেশ এবং সাবস্ক্রিপশন প্ল্যান সহ তৈরি।',
        ...
        'welcome.about_title': 'কেন আমার ব্যাচ?',
        'welcome.about_desc':
        ...
        'welcome.cta_desc':
            'ইতিমধ্যে আমার ব্যাচ ব্যবহারকারী শত শত কোচিং সেন্টারের সাথে যোগ দিন।',
        ...
        'welcome.role_feature': 'রোল-ভিত্তিক প্রবেশাধিকার',
        'welcome.role_desc':
            'অ্যাডমিন এবং শিক্ষক রোল বিভিন্ন অনুমতি সহ। নিরাপদ এবং নিয়ন্ত্রিত প্রবেশ।',
        ...
        // Pricing
        'welcome.pricing_title': 'সহজ, স্বচ্ছ মূল্য',
        'welcome.pricing_desc':
            'আপনার কোচিং সেন্টারের জন্য উপযুক্ত প্ল্যান বেছে নিন। বিনামূল্যে শুরু করুন, প্রয়োজন হলে আপগ্রেড করুন।',
        ...
        'plan.students': 'স্টুডেন্ট',
        'plan.staff': 'স্টাফ',
        'plan.batches': 'ব্যাচ',
        'plan.unlimited_students': 'অসীমিত স্টুডেন্ট',
        'plan.unlimited_staff': 'অসীমিত স্টাফ',
        'plan.unlimited_batches': 'অসীমিত ব্যাচ',
        'plan.feature_students': 'স্টুডেন্ট ব্যবস্থাপনা',
        'plan.feature_batches': 'ব্যাচ ব্যবস্থাপনা',
        'plan.feature_attendance': 'উপস্থিতি ট্র্যাকিং',
        'plan.feature_fees': 'বেতন সংগ্রহ',
        'plan.feature_exams': 'পরীক্ষা ব্যবস্থাপনা',
        'plan.feature_reports': 'রিপোর্ট ও অ্যানালিটিক্স',
        'plan.feature_notifications': 'বিজ্ঞপ্তি',
        ...
        'welcome.faq_desc': 'আমার ব্যাচ সম্পর্কে আপনার জানার সবকিছু।',
        'welcome.faq1_q': 'আমার ব্যাচ কি?',
        'welcome.faq1_a':
            'আমার ব্যাচ একটি সম্পূর্ণ কোচিং সেন্টার ব্যবস্থাপনা প্ল্যাটফর্ম যা আপনাকে স্টুডেন্ট, শিক্ষক, ব্যাচ, উপস্থিতি এবং বেতন পরিচালনা করতে সাহায্য করে।',
        ...
        'welcome.faq4_a':
            'অবশ্যই। আমরা শিল্প-মানদণ্ডের এনক্রিপশন এবং নিরাপত্তা অনুশীলন ব্যবহার করি। আপনার ডেটা টেন্যান্ট অনুযায়ী বিচ্ছিন্ন এবং নিয়মিত ব্যাকআপ নেওয়া হয়।',
    ...
    en: {
        ...
        'dashboard.low_capacity': 'Batches Near Full Capacity',
        'dashboard.no_attendance_today': 'No attendance recorded today',
        'dashboard.mark_attendance_desc': 'Mark attendance to see analytics',
        'dashboard.no_enrollments': 'No enrollment data',
        'dashboard.no_enrollments_desc': 'Enrollment trends will appear here',
        'dashboard.no_fees': 'No fee data',
        'dashboard.no_fees_desc': 'Fee collection trends will appear here',
        'dashboard.view_plans': 'View Plans',
        ...
        'batches.manage': 'Manage Batch',
        'batches.assigned_teachers': 'Assigned Teachers',
        ...
        'roles.slug': 'Slug *',
        'roles.slug_placeholder': 'e.g. teacher',
        ...
        'reports.unpaid_title': 'Unpaid Students',
        'reports.unpaid_desc': 'View students with outstanding fees',
        'reports.unpaid_students_count': 'unpaid students',
        ...
        'fees.generate_receipt': 'Generate Receipt',
        'fees.receipt_desc': 'Select a month to generate the receipt',
        'fees.unpaid_filter': 'Unpaid Month',

        // Receipts
        'receipts.title': 'Fee Receipts',
        'receipts.desc': 'Manage and generate fee receipts',
        'receipts.new': 'New Receipt',
        'receipts.search_placeholder': 'Search receipts...',
        ...
        'receipts.column_student': 'Student',
        'receipts.column_batch': 'Batch',
        'receipts.column_period': 'Period',
        'receipts.column_amount_paid': 'Amount Paid',
        'receipts.column_amount_due': 'Amount Due',
        'receipts.column_date': 'Date',
        'receipts.label_student': 'Student',
        'receipts.label_batch': 'Batch',
        'receipts.label_month': 'Month',
        'receipts.label_year': 'Year',
        'receipts.label_amount_paid': 'Amount Paid',
        'receipts.label_amount_due': 'Amount Due',
        'receipts.label_notes': 'Notes',
        'receipts.notes_placeholder': 'Optional notes',
        'receipts.select_student': 'Select student',
        'receipts.select_student_first': 'Select a student first',
        'receipts.select_batch': 'Select batch',
        'receipts.creating': 'Creating...',
        'receipts.show_title': 'Receipt',
        'receipts.show_generated': 'Generated on',
        'receipts.fee_receipt': 'Fee Receipt',
        'receipts.receipt_number': 'Receipt Number',
        'receipts.date': 'Date',
        'receipts.student_name': 'Student Name',
        'receipts.phone': 'Phone',
        'receipts.guardian_name': 'Guardian Name',
        'receipts.guardian_phone': 'Guardian Phone',
        'receipts.subject': 'Subject',
        'receipts.period': 'Period',
        'receipts.amount_due': 'Amount Due',
        'receipts.amount_paid': 'Amount Paid',
        'receipts.notes': 'Notes',
        'receipts.received_by': 'Received by',
        ...
        'settings.coaching_center': 'Coaching Center',
        'settings.coaching_center_desc':
            'Manage your coaching center information, branding, and preferences.',
        'settings.center_name': 'Coaching Center Name *',
        'settings.phone': 'Phone',
        'settings.timezone': 'Timezone',
        'settings.currency': 'Currency',
        'settings.currency_symbol': 'Currency Symbol',
        'settings.academic_year': 'Academic Year',
        'settings.receipt_prefix': 'Receipt Prefix',
        'settings.student_id_prefix': 'Student ID Prefix',
        'settings.default_attendance': 'Default Attendance',
        'settings.manual': 'Manual',
        'settings.auto_absent': 'Auto Absent (after time)',
        'settings.invoice_footer': 'Invoice Footer Text',
        'settings.primary_color': 'Primary Color (for PDFs)',
        'settings.logo': 'Logo',
        'settings.save_changes': 'Save',
        'settings.theme_mode': 'Theme mode',
        'settings.theme_mode_desc': 'Choose how the app looks on your device.',
        'settings.light': 'Light',
        'settings.light_desc': 'Bright and clear',
        'settings.dark': 'Dark',
        'settings.dark_desc': 'Easy on the eyes',
        'settings.system': 'System',
        'settings.system_desc': 'Follow your device settings',
        'settings.accent_color': 'Accent color',
        'settings.accent_color_desc':
            'Applied to buttons, links, active states, and focus rings.',
        'settings.corner_radius': 'Corner radius',
        'settings.corner_radius_desc':
            'Roundness of buttons, inputs, cards, and dialogs.',
        'settings.custom_size': 'Custom size',
        'settings.sharp': 'Sharp',
        'settings.rounded': 'Rounded',
        'settings.date_time': 'Date & Time',
        'settings.date_time_desc': 'Choose how dates and times are displayed.',
        'settings.date_format': 'Date Format',
        'settings.time_format': 'Time Format',
        'settings.hour_12': '12 hour (AM/PM)',
        'settings.hour_24': '24 hour',
        'settings.layout': 'Layout',
        'settings.layout_desc': 'Customize sidebar and navigation behavior.',
        'settings.sidebar_style': 'Sidebar Style',
        'settings.sidebar_full': 'Full (labels visible)',
        'settings.sidebar_compact': 'Compact (icons only)',
        'settings.default_page': 'Default Landing Page',
        'settings.preview': 'Preview',
        'settings.preview_desc': 'A live sample of your customization.',
        ...
        'super_admin.overview_description': 'Overview of all coaching centers',
        'super_admin.coaching_centers': 'Coaching Centers',
        'super_admin.manage_coaching_centers': 'Manage all coaching centers',
        'super_admin.total_revenue': 'Total Revenue',
        'super_admin.active_subs': 'active subs',
        'super_admin.total_users': 'Total Users',
        'super_admin.subscriptions': 'Subscriptions',
        'super_admin.on_trial': 'on trial',
        'super_admin.view_all': 'View All',
        'super_admin.recent_payments': 'Recent Payments',
        'super_admin.no_coaching_centers': 'No coaching centers yet.',
        'super_admin.no_payments': 'No payments yet.',
        ...
        'super_admin.edit_plan': 'Edit Plan',
        'super_admin.plan_name': 'Plan Name',
        'super_admin.slug': 'Slug',
        'super_admin.description': 'Description',
        'super_admin.monthly_price': 'Monthly Price (৳)',
        'super_admin.yearly_price': 'Yearly Price (৳)',
        'super_admin.max_students': 'Max Students (-1 = unlimited)',
        'super_admin.max_staff': 'Max Staff (-1 = unlimited)',
        'super_admin.max_batches': 'Max Batches (-1 = unlimited)',
        ...
        'super_admin.failed': 'Failed',
        'super_admin.revenue': 'Revenue',
        ...
        'super_admin.no_messages': 'No contact messages yet.',
        'super_admin.reply_to': 'Reply to',
        'super_admin.type_reply': 'Type your reply...',
        'super_admin.send_reply': 'Send Reply',
        'super_admin.sending': 'Sending...',
        'super_admin.previous_reply': 'Previous reply sent',
        'super_admin.search_name_email': 'Search name, email, subject...',
        'super_admin.unread_filter': 'Unread',
        'super_admin.all': 'All',
        'super_admin.students': 'Students',
        'super_admin.batches': 'Batches',
        'super_admin.users': 'Users',
        'super_admin.revenue_label': 'Revenue',
        'super_admin.paid': 'paid',
        'super_admin.recent_payments_short': 'Recent Payments',
        'super_admin.subscription': 'Subscription',
        'super_admin.no_plan': 'No Plan',
        'super_admin.until': 'until',
        'super_admin.plan_details': 'Plan Details',
        'super_admin.change_plan': 'Change Plan',
        'super_admin.no_plan_assigned': 'No plan assigned.',
        'super_admin.select_plan': 'Select a plan',
        'super_admin.assign_plan': 'Assign Plan',
        'super_admin.price': 'Price',
        'super_admin.deactivate': 'Deactivate',
        ...
        'super_admin.create_feature_desc': 'Add a new feature that can be selected in plans.',
        ...
        'super_admin.delete_feature_confirm': 'Are you sure you want to delete "{name}"?',
        ...
        'super_admin.subject': 'Subject',
        'super_admin.no_contacts': 'No contact messages yet.',
        'super_admin.amount': 'Amount',
        'super_admin.billing': 'Billing',
        ...
        'super_admin.payment_settings_desc': 'Configure payment gateway and manual payments',
        ...
        'super_admin.manual_payment_instructions': 'Manual Payment Instructions',
        'super_admin.manual_payment_instructions_placeholder': 'Enter payment instructions for customers...',
        'super_admin.manual_payment_instructions_help': 'These instructions will be shown to customers on the subscription page.',
        'super_admin.manual_payments_desc': 'Review and approve manual payments',
        ...
        'super_admin.approve_payment_confirm': 'Are you sure you want to approve this payment? This will activate the customer\'s subscription.',
        'super_admin.reject_payment': 'Reject Payment',
        'super_admin.reject_payment_confirm': 'Are you sure you want to reject this payment?',
        ...
        'subscription.manual_payment_desc': 'Fill in the details below. Your subscription will be activated after our team verifies the payment.',
